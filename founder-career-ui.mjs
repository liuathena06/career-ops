...
createServer(async (req, res) => {
  ...
  try {
    ...
    if (req.url === '/api/profile') { const founded = createFounderConfirmedProfile({ answers: input.answers }); const intelligence = buildAiCareerProfileSummary({ resumeText: input.resumeText, interview: founded.interview, profile: founded.profile }); return json(res, 200, { ...founded, intelligence, searchStrategy: createOpportunitySearchStrategy({ profile: founded.profile, intelligence }) }); }
