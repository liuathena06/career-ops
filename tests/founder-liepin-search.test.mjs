...
test('Founder UI selects only the agreed search-card fields', () => {
  ...
  assert.deepEqual(card, { jobName: '产品经理', company: '示例公司', location: '上海', salary: '30-50k', education: '本科', workYears: '5年以上', industry: '互联网', financingStage: 'B轮', companySize: '100-499人', jobDetailUrl: 'https://example.invalid/job' });
  assert.equal('jobId' in card, false);
